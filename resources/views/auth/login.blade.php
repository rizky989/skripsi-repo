    ...
    <div class="login-box p-5 text-center col-8">
        ...
        <form action="{{route('login.user')}}" method="POST">
            ...
            <div class="form-group row">
                <label for="email" name="email" class="col-md-4 col-form-label text-md-right login-label">Email :
                </label>
                <div class="col-md-6">
            ...
            <div class="form-group row">
                <label for="password" name="password" class="col-md-4 col-form-label text-md-right login-label">Password
                    : </label>
                <div class="col-md-6">
